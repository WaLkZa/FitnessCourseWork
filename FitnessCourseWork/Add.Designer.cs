...
namespace FitnessCourseWork
{
	partial class Add
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Номер на зала:";
			// 
			// label2
			// 
			...
			// button1
			// 
			this.button1.Location = new System.Drawing.Point(164, 338);
			...
			"Фитнес уреди",
			"Гимнастика"});
			this.comboBox1.Location = new System.Drawing.Point(196, 136);
			...
			// textBox2
			// 
			this.textBox2.Location = new System.Drawing.Point(196, 202);
			...
			// textBox3
			// 
			this.textBox3.Location = new System.Drawing.Point(196, 270);
